...
export default function Dashboard() {
  ...
  const handleLoginSuccess = (userData) => {
    ...
    navigate("/pcoschat"); // redirect to chatbot
  };
  // Logout function
  const handleLogout = () => {
  ...
  return (
    <div className="bg-[#f7f5fb] min-h-screen flex flex-col items-center py-12 px-4 relative">
      ...
      <div className="absolute top-4 right-4 flex gap-2">
        ...
        <button
              className="bg-purple-500 hover:bg-red-600 text-white px-4 py-2 rounded-full font-semibold transition"
      ...
      <div className="text-center max-w-2xl mb-12">
        ...
        <Link to="/pcoschat">
          <button className="bg-purple-500 hover:bg-purple-600 text-white px-6 py-3 rounded-full font-semibold transition">
  ...
  <p className="mt-3 mb-10 text-gray-700 max-w-md">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 w-full max-w-6xl">
      ...
      <AuthModal
        ...
        setUser={handleLoginSuccess} // logic to redirect after login
      />
    </div>
  );
}
